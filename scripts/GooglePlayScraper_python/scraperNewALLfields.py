...
def _add_reviews(appId,reviews):
     ...
     return jsonpickle.encode(reviewsJson)
...
#This method adds the missing fields to the android collection(*android_compatiblity & *android_ratingsAllCersions) Also adds the app description and reviews.
def app_info(app_id,reviews, language='en_US'):
    print app_id
    ...
    collection.find_one_and_update({"android_app_id":app_id}, {'$set': {'android_reviews':jsonpickle.decode(reviews),'android_compatibility':android_compatibility, 'android_ratingsAllVersions':android_reviews_sum,'android_description':android_description}  })
# Main method
if (__name__ == '__main__'):
    ...
    for app in apps:
     ...
     reviews=_add_reviews(app,scraped)
     app_info(app,reviews)
