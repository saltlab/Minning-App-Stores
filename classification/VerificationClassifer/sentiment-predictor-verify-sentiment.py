...
if __name__ == "__main__":
    ...
    path = '/Users/mohamedali/Minning-App-Stores/classification/verifyClassifiersData/1-sentimentClassifier/1-Positive'  # remove the trailing '\'
    problemDiscovery = []
    ...
    path = '/Users/mohamedali/Minning-App-Stores/classification/verifyClassifiersData/1-sentimentClassifier/2-Negative'  # remove the trailing '\'
    featureRequest = []
    for dir_entry in os.listdir(path):
        dir_entry_path = os.path.join(path, dir_entry)
        if os.path.isfile(dir_entry_path):
    ...
    path = '/Users/mohamedali/Minning-App-Stores/classification/verifyClassifiersData/1-sentimentClassifier/3-Neutral'  # remove the trailing '\'
    nonInformative = []
    for dir_entry in os.listdir(path):
        dir_entry_path = os.path.join(path, dir_entry)
        if os.path.isfile(dir_entry_path):
    ...
    restored_classifier = joblib.load('posClassifier7Apps/mysentiment-classifier.pkl')
    ...
    print "positive Precision:"+str(problemDiscoveryPrecision)
    print "positive Recall:"+str(problemDiscoveryRecall)
    print "positive F-measure:"+str(problemDiscoveryFmeasure)
    print "********"
    ...
    print "negative Precision:"+str(featureRequestPrecision)
    print "negative Recall:"+str(featureRequestRecall)
    print "negative F-measure:"+str(featureRequestFmeasure)
    print "********"
    ...
    print "neutral Precision:"+str(nonInformativePrecision)
    print "neutral Recall:"+str(nonInformativeRecall)
    print "neutral F-measure:"+str(nonInformativeFmeasure)
    print "********"
