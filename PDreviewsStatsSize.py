...
def _getCollection():
     ...
     for post in  collection_ios.find().batch_size(30):
         ...
         android_reviews=post['android_numPD']
         ios_reviews=post['ios_numPD']
         title=post['ios_name']
         ...
         print "ios_reviews"
         print (ios_reviews)
         android_numReviews=android_numReviews+(android_reviews)
         ios_numReviews=ios_numReviews+(ios_reviews)
